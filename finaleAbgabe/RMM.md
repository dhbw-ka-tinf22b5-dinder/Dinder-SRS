...
|-------|----------|------------------------|-----------|------|-------------|----------------------------------------------------|----------------------------|----------------------------------------|-----------|--------|------------------|
|1      |DB        |DB-Server is unavailable|<1%        |HIGH  |3 out of 10  |Usage of HA and Fault Tolerance for better stability|no response                 |Transfer to new DB, via Transaction Logs|Manuel     |pending |11. April         |
|2      |Quality   |Bugs in the software    |100%       |HIGH  |9 out of 10  |Usage of Tests (so far ~63%), Code Reviews          |unexpected software behavior|Fix the issues                          |All        |pending |13. June          |
|3      |Management|loss of personell       |15%        |HIGH  |6 out of 10  |Exchange on critical reviews, exchange of knowledge |Many bad exams              |Reduction of the software               |All        |occurred|14. June          |
